...
$pkg_source="https://public-cd-buildkite-cache.s3-us-west-2.amazonaws.com/rubyinstaller-devkit-2.6.5-1-x64.exe/oneclick/rubyinstaller2/releases/download/RubyInstaller-${pkg_version}-${pkg_revision}//rubyinstaller-devkit-${pkg_version}-${pkg_revision}-x64.exe"
